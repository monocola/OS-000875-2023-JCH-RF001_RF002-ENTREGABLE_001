...
export abstract class PerfilesRepository {
  ...
  abstract revisarPerfil (perfilIdentificacionId: number, estadoRevision: number): Observable<any>;
  ...
  abstract getPlantillaRegimen (regimen: string): Observable<any>;
  abstract uploadPlantilla (request: any): Observable<any>;
}

...
export abstract class AdministratorRepository {
  ...
  abstract validDuplicateRequest(ruc: number, doc: number): Observable<any>;
  ...
  abstract insConfigMaestra(entidadId: number): Observable<any>;
  abstract registerPostulante(data: RegistroPostulante): Observable<Boolean>;
}

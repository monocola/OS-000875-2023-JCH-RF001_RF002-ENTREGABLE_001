...
@Component({
  selector: 'serv-talento-table-reporte-convocatoria',
  templateUrl: './table-reporte-convocatoria.component.html',
  styleUrls: ['./table-reporte-convocatoria.component.scss'],
})
export class TableReporteConvocatoriaComponent

...
public class SolicitudPersonaDTO {
	...
	@Size(max = 1, message = "Campo validar es inválido, máximo 1 caracter")
	private String validar;
	@Size(max = 200, message = "Campo razonSocial es inválido, máximo 200 caracteres")
	private String razonSocial;
	@Size(max = 200, message = "Campo nombreComercial es inválido, máximo 200 caracteres")
	private String nombreComercial;
	@Size(max = 15, message = "Campo nombreComercial es inválido, máximo 15 caracteres")
	...
	@Size(max = 5, message = "Campo actividadEconomicaPrincipal es inválido, máximo 5 caracteres")
	private String actividadEconomicaPrincipal;
	@Size(max = 50, message = "Campo condicionContribuyente es inválido, máximo 50 caracteres")
	private String condicionContribuyente;
	@Size(max = 50, message = "Campo estadoConstribuyente es inválido, máximo 50 caracteres")
	...
	@Size(max = 50, message = "Campo lugarNacimiento es inválido, máximo 50 caracteres")
	private String lugarNacimiento;
	
	private List<SolicitudArchivoDTO> listaArchivo;
}

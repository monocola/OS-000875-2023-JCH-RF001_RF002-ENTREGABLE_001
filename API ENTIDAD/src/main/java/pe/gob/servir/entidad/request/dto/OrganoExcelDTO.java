...
public class OrganoExcelDTO {
	...
	public String getObservacion() {//NOSONAR
		...
		try {			   
				if(estado.equals(Constantes.SELECCIONAR) && nivel.equals(Constantes.SELECCIONAR) && StringUtils.isEmpty(nombreOrgano) && StringUtils.isEmpty(sigla) && naturaleza.equals(Constantes.SELECCIONAR) &&
						 tipoDocumento.equals(Constantes.SELECCIONAR) && StringUtils.isEmpty(nroDocumento) && StringUtils.isEmpty(nombres) && StringUtils.isEmpty(apellidoPaterno) && StringUtils.isEmpty(apellidoMaterno)  && 
				...
				if (naturaleza.equalsIgnoreCase(Constantes.SELECCIONAR) || !validarCantidadCarecteres(naturaleza, 4)) {
					this.observacion = this.observacion + "Seleccione Naturaleza,";
				}
	...
	public String getEliminarFila() {//NOSONAR
		...
		StringUtils.defaultString(naturaleza);
		StringUtils.defaultString(tipoDocumento);
		StringUtils.defaultString(pais);
		try {
			
			if(estado.equals(Constantes.SELECCIONAR) && nivel.equals(Constantes.SELECCIONAR) && naturaleza.equals(Constantes.SELECCIONAR) &&
			...
			if(estado.equals(Constantes.VACIO) && nivel.equals(Constantes.VACIO) && naturaleza.equals(Constantes.VACIO) &&
